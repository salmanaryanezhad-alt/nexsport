...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "برخلاف برنامه‌های دیگر، در نکس‌اسپورت مجبور به سیدبندی اجباری نیستید. می‌توانید همه‌چیز را تصادفی بگذارید یا فقط چند سرگروه شاخص انتخاب کنید.",
  },
  {
...
const FAQS = [
  {
    q: "آیا برای استفاده از برنامه‌ریز مسابقات نکس‌اسپورت (NexSport) باید ثبت‌نام کنم؟",
    a: "خیر! استفاده از تمامی امکانات نکس‌اسپورت (تولید برنامه مسابقات، جدول رده‌بندی، چاپ و خروجی اکسل) بدون نیاز به ثبت‌نام و کاملاً رایگان است. در عین حال با ایجاد حساب کاربری می‌توانید مسابقات خود را در فضای ابری ذخیره کرده و از هر دستگاهی به آنها دسترسی داشته باشید.",
  },
  {
    q: "چگونه مطمئن شوم هیچ مسابقه تکراری در لیگ ایجاد نمی‌شود؟",
    a: "موتور برنامه‌ریزی نکس‌اسپورت از الگوریتم استاندارد جهانی Circle Method (روش دوره‌ای برگر) استفاده می‌کند. این الگوریتم تضمین ریاضی می‌دهد که هر تیم دقیقاً یک‌بار (یا در رفت‌وبرگشت، دقیقاً دو بار با جابه‌جایی میزبان) مقابل هر حریف قرار بگیرد.",
  },
  {
  ...
  },
  {
    ...
    a: "نکس‌اسپورت برای تمامی مسابقات ورزشی از جمله فوتبال، فوتسال، والیبال، بسکتبال، پینگ‌پنگ، بدمینتون، شطرنج، تنیس و حتی تورنمنت‌های بازی‌های ویدیویی (FIFA، PES، Call of Duty) کاملاً کاربردی و قابل استفاده است.",
  },
];
        ...
        <section id="formats" className="mx-auto max-w-6xl px-6 py-20 scroll-mt-20">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-sm text-ink/70 leading-7">
              چه یک لیگ محلی ۴ نفره داشته باشید و چه تورنمنت بزرگ ۶۴ تیمی، نکس‌اسپورت دقیق‌ترین الگوریتم
        ...
        <section id="features" className="bg-chalk/60 border-y border-line py-20 scroll-mt-20">
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center max-w-2xl mx-auto space-y-3">
              ...
              <h2 className="text-3xl font-black text-ink">چرا نکس‌اسپورت بهترین انتخاب برگزارکنندگان است؟</h2>
              <p className="text-sm text-ink/70 leading-7">
        ...
        <section className="bg-pitch py-16 text-chalk relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center space-y-6">
            ...
            <p className="text-sm sm:text-base text-chalk/80 max-w-xl mx-auto leading-7">
              همین حالا و بدون نیاز به نصب هیچ نرم‌افزاری، اولین جدول مسابقات خود را در نکس‌اسپورت
              بسازید.
            </p>
            <div className="pt-2">
              <Link
      ...
      <footer className="border-t border-line bg-chalk py-12 text-ink">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-8 md:grid-cols-12 items-start">
            <div className="md:col-span-6 space-y-3">
              ...
              <p className="text-xs text-ink/70 leading-6 max-w-md">
                نکس‌اسپورت پلتفرم هوشمند مدیریت و برنامه‌ریزی مسابقات ورزشی است. هدف ما حذف پیچیدگی‌های
          ...
          <div className="mt-10 border-t border-line/70 pt-6 flex flex-wrap items-center justify-between gap-4 text-xs text-ink/50">
            <p>© {new Date().getFullYear()} تمامی حقوق برای سامانه ورزشی نکس‌اسپورت محفوظ است.</p>
